...
سخت ہدایت:
• اشعار صرف نیچے دیے گئے سیاق (context) سے لیں — ایک لفظ بھی خود نہ بنائیں
• اگر کوئی شعر context میں نہ ملے تو اس نمبر کی جگہ لکھیں: [شعر دستیاب نہیں]
• شعر بالکل جوں کا توں نقل کریں — کوئی تبدیلی نہیں
...
ہدایت: درج ذیل اشعار میں سے کوئی چار کی تشریح حوالہ کے ساتھ لکھیں۔
                        ...
                        (حصہ نظم)
context میں موجود نظموں سے ۴ مختلف اشعار نکال کر (i) تا (iv) میں لکھیں:
فارمیٹ ہر شعر کا:
(نمبر) [شعر کا پہلا مصرع]
        [شعر کا دوسرا مصرع]
        (نظم: [عنوان] — شاعر: [نام])

                        (حصہ غزل)
context میں موجود غزلوں سے ۳ مختلف اشعار نکال کر (v) تا (vii) میں لکھیں:
فارمیٹ ہر شعر کا:
(نمبر) [شعر کا پہلا مصرع]
        [شعر کا دوسرا مصرع]
        (غزل: از [شاعر کا نام])
...
• شعر مکمل ہو (دونوں مصرعے)
• صرف context کا مواد — کچھ بھی خود نہ لکھیں
"""
